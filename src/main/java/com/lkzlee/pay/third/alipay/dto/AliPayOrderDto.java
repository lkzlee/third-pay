...
public class AliPayOrderDto extends AbstThirdPayDto
{
	...
	{
		return "AliPayOrderDto [service=" + service + ", partner=" + partner + ", seller_id=" + seller_id
				+ ", _input_charset=" + _input_charset + ", payment_type=" + payment_type + ", notify_url="
				+ notify_url + ", return_url=" + return_url + ", anti_phishing_key=" + anti_phishing_key
				+ ", exter_invoke_ip=" + exter_invoke_ip + ", out_trade_no=" + out_trade_no + ", subject=" + subject
