 ...
 *
 */
public class WeiXinOrderResultDto extends AbstThirdPayDto implements Serializable
{
	...
	{
		return "WeiXinOrderResultDto [return_code=" + return_code + ", return_msg=" + return_msg + ", err_code="
