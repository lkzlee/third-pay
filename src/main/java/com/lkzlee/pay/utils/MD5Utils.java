...
public class MD5Utils {
	 ...
	 */
	protected static String getMD5Lower(String srcStr)
			throws NoSuchAlgorithmException {
		String sign = "lower";
	 ...
	 * @throws NullPointerException
	 */
	protected static String getMD5Upper(String srcStr)
			throws NoSuchAlgorithmException {
		String sign = "upper";
		return processStr(srcStr, sign);
	}
	...
	public static void main(String[] args) {
		String content = getMD5("act_name=test act name&client_ip=203.81.22.169&max_value=100&mch_billno=1239473302201504281234567890&mch_id=1239473302&min_value=100&nick_name=智相科技&nonce_str=5K8264ILTKCH16CQ2502SI8ZNMTM67VS&re_openid=oz45Tt1eHadsai67QGhrohomsSN0&remark=test remark&send_name=智相科技&total_amount=100&total_num=1&wishing=test wishing&wxappid=wx9187b72329d7b103&key=9879795252c0784c8ce61af9acb9bbe0");
