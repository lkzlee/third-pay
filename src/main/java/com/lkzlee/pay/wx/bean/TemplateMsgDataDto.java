...
public class TemplateMsgDataDto
{
	...
	public TemplateMsgDataDto(String touser, String template_id, String url)
	{
		this.touser = touser;
	...
	public TemplateMsgDataDto push(String key, String value, String color)
	{
		this.data.addItem(key, value, color);
		return this;
	}

	public TemplateMsgDataDto push(String key, String value)
	{
